...
<div class="heading-buttons">
    <h3 class="glyphicons coins"><i></i> Quản lý danh mục</h3>
    <div class="buttons pull-right">
        <a class="btn btn-primary btn-icon glyphicons circle_plus" href="CatalogAdd.php"><i></i> Add new</a>
    </div>
    ...
    <table
        ...
        <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0"
                ...
                aria-label="Rendering eng.: activate to sort column ascending">Catalog.
            </th>
