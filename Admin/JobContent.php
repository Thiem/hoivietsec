...
<ul class="breadcrumb">
    ...
    <li class="divider"></li>
    <li>Danh sách ngành nghề -công việc đã làm ở Séc</li>
</ul>
            ...
            <ul>
                ...
                if ($page > 1) {
                    ...
                    if ($current != 1) {
                        ?>
                        <li>
                            <a href='Job.php?rows=<?php echo $display ?>&start=<?php echo $prev ?>'>Previous</a>
                        </li>
                    <?php
                    }
                    // Hien thi so link
                    for ($i = 1; $i <= $page; $i++) {
                        if ($current != $i) {
                            ?>
                            <li>
                                <a href='Job.php?rows=<?php echo $display ?>&start=<?php echo($display * ($i - 1)) ?>'><?php echo $i ?></a>
                            </li>
                        <?php
                        } else {
                            ?>
                            <li class="active"><a
                                    href='Job.php?rows=<?php echo $display ?>&start=<?php echo($display * ($i - 1)) ?>'><?php echo $i ?></a>
                            </li>
                        <?php
                        }
                    ...
                    if ($current != $page) {
                        ?>
                        <li>
                            <a href='Job.php?rows=<?php echo $display ?>&start=<?php echo $next ?>'>Next</a>
                        </li>
                    <?php
                    }
                }
...
<script>
    function Pagination() {
        location.href = "Job.php?rows=" + $('#pagination').val();
    }
</script>
