    ...
    <div class="content" id="member-pages">
        <div id="fsearchmember">
            <form id="MemberIndexForm" method="post" action="Member.php" accept-charset="utf-8">
                ...
                <input name="data[Member][tukhoa]" type="text" class="input" maxlength="50" id="MemberHotendem"  <?php if (isset($val['Member']['tukhoa'])){?> value="<?php echo $val['Member']['tukhoa'] ?>" <?php }?>>
            ...
            if ($info == null) {
                ...
                foreach ($info as $selectArrayItem) {
                    ...
                    <tr>
                        ...
                        <td><a href="MemberDetail.php?id=<?php echo $selectArrayItem->mem_id; ?>"><?php echo $selectArrayItem->fullname; ?></a></td>
        ...
        <div class="paging">
            ...
            if ($page > 1) {
                ...
                if ($current != 1) {
                    ?>
                    <span>
                        <a href='Association.php?rows=<?php echo $display ?>&start=<?php echo $prev ?>'>Prev</a>
                    </span> |
                <?php
                }
                // Hien thi so link
