...
<div class="body_left">
    <div id="breadcrumb"><span class="breadcrumb-home"><a href="/">Trang chủ</a> <!--&rsaquo;&rsaquo; --> ›› <a
                href="NoticePage.php">Thông báo</a></span>
    </div>
    <div class="content">
        <div class="aticle-title">
            <?php echo $arrayItem->no_title;?>
            <P>
                <small>Ngày đăng:<?php echo $arrayItem->no_date;?></small>
            </P>
        </div>
        <div class="clr"></div>
        ...
        <br>
        <p align="center" style="float: right"><?php echo $arrayItem->no_author;?></p>
        <br>
            ...
            foreach($news as $newsItem){
                ...
                <ul>
                    <li style="margin-right:15px;">
                        <a class="text_12_xanh" href="NoticeDetailed.php?id=<?php echo $newsItem->no_id;?>"><?php echo $newsItem->no_title;?></a>(<?php echo $newsItem->no_date;?>)
                    </li>
                </ul>
            <?php } ?>
            <div class="clr"></div>
